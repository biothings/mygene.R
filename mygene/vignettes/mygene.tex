%\VignetteIndexEntry{How to use MyGene.info R Client}
%\VignetteKeywords{annotation, database}
%\VignettePackage{mygene}
%\VignetteEngine{util::Sweave}
...
\end{Sinput}
\begin{Soutput}
 chr "name,symbol,taxid, entrezgene"
$`_id`
[1] "1017"
...
\begin{itemize}
\item Use \Rfunction{mg.getgenes}, the wrapper for POST query of "/gene" service, to return the list of gene objects for the given list of geneids.
\end{itemize} 
...
+              fields='entrezgene,uniprot', species='human')
\end{Sinput}
\begin{Soutput}
Finished
Pass returnall=TRUE to return lists of duplicate or missing query terms.
