...
<<>>=
xli<-c('DDX26B', 'CCDC83', 'MAST3', 'FLOT1', 'RPL11', 'ZDHHC20', 'LUC7L3', 'SNORD49A', 'CTSH', 'ACOT8')
@
...
<<>>=
xli<-c('DDX26B', 'CCDC83', 'MAST3', 'FLOT1', 'RPL11', 'Gm10494')
queryMany(xli, scopes="symbol", fields="entrezgene", species="human")
@
...
<<>>=
xli<-c('DDX26B', 'CCDC83', 'MAST3', 'FLOT1', 'RPL11', 'Gm10494', '1007_s_at', 'AK125780')
